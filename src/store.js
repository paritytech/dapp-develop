...
import SolidityUtils from '@parity/shared/lib/util/solidity';
...
const SNIPPETS = {
  snippet0: {
    ...
    id: 'snippet0',
    sourcecode: require('raw-loader!@parity/shared/lib/contracts/snippets/token.sol')
  },
  snippet1: {
    ...
    id: 'snippet1',
    sourcecode: require('raw-loader!@parity/shared/lib/contracts/snippets/standard-token.sol')
  },
  snippet2: {
    ...
    id: 'snippet2',
    sourcecode: require('raw-loader!@parity/shared/lib/contracts/snippets/human-standard-token.sol')
  },
  snippet3: {
    name: 'Wallet.sol',
    description: (
    ...
    id: 'snippet3',
    sourcecode: require('raw-loader!@parity/shared/lib/contracts/snippets/wallet.sol')
  }
};
